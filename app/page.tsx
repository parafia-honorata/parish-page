...
export default function Home() {
  ...
  return (
    <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
      {}
      <article>
        {blogLoading  ? (<LoaderCircle className="animate-spin h-12 w-12 mt-12"/>) :
          blogData
        }
      </article>
      <article>
      ...
      <article>
        ...
        <p>W młodości, idąc za przykładem ojca, uczył się na architekta. Wstąpił do płockiego gimnazjum. Zostaje doświadczony na wiele sposobów, młodzieńczym niedowiarstwem, przedwczesną śmiercą ojca, a wreszcie wtrąceniem do carskiego więzienia. Z warszawskiej Cytadeli wyszedł odmieniony. Po przeżytym nawróceniu stał się spokojny i pogodzony z Bogiem. Niedługo później rozpoczął swoje życie zakonne jako Kapucyn.</p>
